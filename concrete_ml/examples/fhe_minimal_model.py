...
def test_transformer_block():
    ...
    print("\n=== Testing Simplified Transformer Block ===")
...
if __name__ == "__main__":
    print("Starting FHE-compatible model tests...")
    
    # Test the minimal model
    quantized_minimal, minimal_model, minimal_mae = test_minimal_model()
    ...
    if minimal_mae < 0.1:  # Only try the transformer if minimal model works
        ...
        quantized_transformer, transformer_model, transformer_mae = test_transformer_block()
    else:
