...
class ScaledSinosoidal(SinusoidalPositional):
    ...
    def __init__(self, embedding_dim, max_seq_length):
        ...
        # print('\n============== ScaledSinosoidal init ==============')
        # print(f'embedding_dim: {embedding_dim}')
        # print('ScaledSinosoidal init', self.scale_factor.data)
        # print('============== ScaledSinosoidal init end ==============\n')
        # print('self.pe', self.pe.shape) # 1, 128, 768
    def forward(self, input_ids):
        r"""Inputs of forward function
        Args:
            x: the sequence fed to the positional encoder model (required).
        ...
        Examples:
            >>> output = pos_encoder(x)
        """
        # print('\n============== ScaledSinosoidal forward ==============')
        # print(f'ScaledSinosoidal input_ids: {input_ids}')
        # print(f'ScaledSinosoidal input_ids: {input_ids.shape}')
        # print('self.scale_factor * self.pe[:, : input_ids.shape[1], :]', (self.pe[:, : input_ids.shape[1], :]))
        # print('============== ScaledSinosoidal forward end ==============\n')
